                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                  {#await data then data}
                    {#each data._embedded.tests as test (test.id)}
                      <li><a class="dropdown-item" href={`/test/${test.id}`}>{test.title}</a></li>
                    {/each}
                  {/await}
                </ul>
            </li>
